        ...
        <div style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              <span style={{ fontSize: '14px', color: '#333' }}>株式会社フーズコネクト</span>
            ...
            {userMenuOpen && (
              <div style={{
                ...
                <div style={{ padding: '15px', borderBottom: '1px solid #e8e8e8' }}>
                  <div style={{ fontSize: '14px', fontWeight: '600', marginBottom: '5px' }}>株式会社フーズコネクト</div>
                  <div style={{ fontSize: '12px', color: '#666' }}>issui0707@gmail.com</div>
                </div>
